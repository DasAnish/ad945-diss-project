...
\begin{description}
    ...
    \item[src/] This is the most important directory and contains the meat of the project. It contains the preprocessing, training and utility scripts along with the transformer architecture definition. Finally, there is an \fbox{opt.py} which contains a singleton class that is used to pass arguments around.
\end{description}
...
\begin{table}[H]
\centering
\resizebox{\textwidth*5/6}{!}{%
\begin{tabular}{@{}cccc@{}}
\toprule
\toprule
\multicolumn{4}{c}{\textbf{de}, epoch size: 20.6k}                                                               \\ \midrule
\multirow{2}{*}{Model} & \multirow{2}{*}{BLEU} & {\textit{reference} PERF-TRANS} & {\textit{reference} GV-crowd} \\
                     &                      & rouge-($1|2|L|W$)-f1 & rouge-($1|2|L|W$)-f1 \\
...
\begin{tabular}{@{}cccc@{}}
\toprule
\multicolumn{4}{c}{\textbf{es}, epoch size: 17.7k}                                                               \\ \midrule
\multirow{2}{*}{Model} & \multirow{2}{*}{BLEU} & {\textit{reference} PERF-TRANS} & {\textit{reference} GV-crowd} \\
                     &                      & rouge-($1|2|L|W$)-f1 & rouge-($1|2|L|W$)-f1 \\
...
\begin{tabular}{@{}cccc@{}}
\toprule
\multicolumn{4}{c}{\textbf{fr}, epoch size: 9.1k}                                                               \\ \midrule
\multirow{2}{*}{Model} & \multirow{2}{*}{BLEU} & {\textit{reference} PERF-TRANS} & {\textit{reference} GV-crowd} \\
                     &                      & rouge-($1|2|L|W$)-f1 & rouge-($1|2|L|W$)-f1 \\
...
\begin{table}[H]
\centering
\resizebox{\textwidth*4/5}{!}{
\begin{tabular}{ccc}
\toprule

\multicolumn{3}{c}{$\Delta \text{rouge} / \Delta \text{bleu} \text{ for } (1\;|\;2\;|\;L\;|\;W)$} \\

 & \textit{reference} PERF-TRANS & \textit{reference} GV-crowd \\

\midrule
& \multicolumn{2}{c}{de} \\
80k vs 5k  & $0.85\;|\;0.64\;|\;0.70\;|\;0.35$ & $0.60\;|\;0.37\;|\;0.40\;|\;0.20$ \\
80k vs 10k & $0.66\;|\;0.54\;|\;0.44\;|\;0.27$ & $0.22\;|\;0.19\;|\;0.10\;|\;0.10$ \\

\midrule
& \multicolumn{2}{c}{es} \\
110k vs 5k  & $0.74\;|\;0.63\;|\;0.68\;|\;0.36$ & $0.43\;|\;0.24\;|\;0.26\;|\;0.13$ \\
110k vs 10k & $0.47\;|\;0.49\;|\;0.43\;|\;0.25$ & $0.24\;|\;0.18\;|\;0.15\;|\;0.08$\\

\midrule
& \multicolumn{2}{c}{fr} \\
72k vs 6k  & $0.84\;|\;0.60\;|\;0.74\;|\;0.36$ & $0.58\;|\;0.28\;|\;0.37\;|\;0.17$ \\
72k vs 18k & $0.61\;|\;0.56\;|\;0.53\;|\;0.27$ & $0.40\;|\;0.26\;|\;0.17\;|\;0.11$ \\

\bottomrule

\end{tabular}
}
\caption{Table representing the ratio of the increase in rouge scores to the increase in BLEU scores}
